...
const validate = (value, context, {
  format = 'MM/DD/YYYY', displayFormat = 'MM/DD/YYYY', start = {}, end = {}, errorMessage,
} = {}) => {
  ...
  const text = errorMessage || `Date must be between ${startDate.format(displayFormat)} and ${endDate.format(displayFormat)}`;
  return (date.isValid()
